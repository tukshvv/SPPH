    ...
    <div class="grid gap-10 lg:grid-cols-[minmax(0,1fr)_380px]">
      ...
      <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-lg">
        ...
        <div class="mt-10 rounded-2xl border border-slate-200 bg-slate-50 p-5">
          <h3 class="text-base font-semibold text-slate-900">Уже есть аккаунт?</h3>
          <p class="mt-1 text-xs text-slate-500">Войдите по e-mail и паролю, чтобы восстановить профиль и статистику.</p>
